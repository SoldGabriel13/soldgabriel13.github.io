...
export const glottalTable2 = [
  scale*0.029667282988045097,
  scale*0.022973393589114006,
  scale*0.019859465074108563,
  scale*0.006484483928043141,
  scale*-0.015968612311273424,
  scale*-0.010438285233274731,
  scale*-0.0011029430267974832,
  scale*-0.010734790334149794,
  scale*-0.004221948350146856,
  scale*-0.009146619748032265,
  scale*-0.012137716219080883,
  scale*-0.013908902336617575,
  scale*-0.013121248546927096,
  scale*-0.004277317099097878,
  scale*-0.0030746505545935624,
  scale*0.009654227832775744,
  scale*0.0018521473115222064,
  scale*0.007104934675222602,
  scale*0.006543476652595889,
  scale*0.007076318500430636,
  scale*0.009238919557581573,
  scale*0.00992825767736157,
  scale*0.012220881890454335,
  scale*0.0016097557729848196,
  scale*0.001802604886247351,
  scale*-0.004196620868846315,
  scale*-0.0026771938523809024,
  scale*0.001689822971052021,
  scale*0.002302101462007397,
  scale*0.005739289260663858,
  scale*0.003263516165019494,
  scale*0.0010223376428101995,
  scale*-0.011787899695923986,
  scale*-0.005796268021837386,
  scale*-0.004864424634683568,
  scale*-0.007028525102347016,
  scale*-0.007162740875980614,
  scale*-0.006125204897068227,
  scale*-0.009713930974864372,
  scale*-0.009629730628361819,
  scale*-0.017450354718909676,
  scale*-0.009643932776378058,
  scale*-0.0024004152078049216,
  scale*0.00412090864223286,
  scale*0.006257639824940438,
  scale*0.004653670173400831,
  scale*0.007745062926949143,
  scale*0.005690681893249166,
  scale*0.004523171572430578,
  scale*0.00010764117767766233,
  scale*0.003126628943721131,
  scale*0.0018436039970510134,
  scale*-0.003515724313937982,
  scale*-0.003611345134429361,
  scale*-0.016668561562980033,
  scale*-0.006066468734224408,
  scale*-0.005738279526396545,
  scale*0.0013928300753408502,
  scale*0.0006514624657268003,
  scale*0.008091625854801693,
  scale*0.0032516787797292825,
  scale*-0.003593702992971824,
  scale*0.00037851349202154864,
  scale*-0.012849480349335177,
  scale*-0.00403305857119731,
  scale*0.0014334997400920146,
  scale*-0.0068711568954214165,
  scale*-0.00969102891047744,
  scale*-0.010204551530653505,
  scale*-0.011311734189556076,
  scale*-0.012833258946253418,
  scale*-0.008325477622302766,
  scale*-0.014075495304809973,
  scale*-0.0024091149363112277,
  scale*0.0013268134541941268,
  scale*-0.006490577478337557,
  scale*0.002777398357199649,
  scale*0.019819073283313955,
  scale*0.0254493446913564,
  scale*0.03375610770888254,
  scale*0.03321212867060505
];
